...
1. Ensure all tests pass (`pytest`).
2. Zip the entire `url-shortener` directory (excluding `venv/` and `__pycache__`).
3. Include `README.md`, `requirements.txt`, and `NOTES.md`.
4. Submit as per the instructions in the README above.
